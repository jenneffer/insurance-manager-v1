        ...
        <!-- <form name='insuranceForm' id='insuranceForm' action="{{ route("admin.insurances.store") }}" method="POST" enctype="multipart/form-data"> -->
            ...
            <div class="row form-group">
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" name="ins_agent" id="ins_agent">   
                </div>
                <div class="col-sm-3">
                    <label for="ins_company">Policy Holder <span style="color:red;">*</span></label>
                    <input name="ins_company" id="ins_company" class="form-control">
                </div>
                <div class="col-sm-3">
                    <label for="ins_class">Product <span style="color:red;">*</span></label>
                    <input name="ins_class" id="ins_class" class="form-control">
                </div>
                <div class="col-sm-3">
                    <label for="ins_policy_no">Policy No. <span style="color:red;">*</span></label>
                    <input name="ins_policy_no" id="ins_policy_no" class="form-control">
                </div>                  
            </div>
            <div class="form-group">
                <label for="ins_correspond_address">Correspondence Address <span style="color:red;">*</span></label>
                <input name="ins_correspond_address" id="ins_correspond_address" class="form-control">
            </div>
            <div class="row form-group">
                <div class="col-sm-3">
                    <label for="ins_date_start">Date start <span style="color:red;">*</span></label>
                    <input name="ins_date_start" id="ins_date_start" class="form-control date">
                </div>
                <div class="col-sm-3">
                    <label for="ins_date_end">Date end <span style="color:red;">*</span></label>
                    <input name="ins_date_end" id="ins_date_end" class="form-control date">
                </div>  
                <div class="col-sm-3">
                    <label for="ins_issuing_branch">Issuing Branch</label>
                    <input name="ins_issuing_branch" id="ins_issuing_branch" class="form-control">
                </div>
                <div class="col-sm-3">
                    <label for="ins_issuing_date">Issuing date</label>
                    <input name="ins_issuing_date" id="ins_issuing_date" class="form-control date">
                </div>                      
            </div>              
            <div class="row form-group">
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    ...
                    <input name="ins_total_sum_insured" id="ins_total_sum_insured" class="form-control">
                </div>                  
            </div> 
